    ...
    <template #body>
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="space-y-3">
          ...
          <!-- Thumbnails -->
          <div v-if="property.imageUrls && property.imageUrls.length > 1" class="flex gap-2 overflow-x-auto">
            <div 
        ...
        <div class="space-y-4">
          ...
          <div class="p-4 bg-gray-50 dark:bg-gray-800 rounded-xl">
            ...
            <div class="grid grid-cols-2 gap-y-3 text-sm">
              ...
              <span class="dark:text-white text-right">{{ property.m2 || property.area || '—' }} m²</span>
              
              <span class="text-gray-500 font-medium">Habitaciones:</span>
              <span class="dark:text-white text-right">{{ property.rooms || property.bedrooms || '—' }}</span>
          ...
          <div class="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl">
            <p class="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wider">Precio</p>
          ...
          <!-- Agent Info -->
          <div class="p-4 bg-gray-50 dark:bg-gray-800 rounded-xl">
            <h4 class="text-xs font-black text-gray-500 uppercase tracking-widest mb-2">Agente Responsable</h4>
            <div class="flex items-center gap-3">
              ...
              <div>
                <p class="font-semibold dark:text-white">{{ property.agentName || 'Agente asignado' }}</p>
                <p class="text-xs text-gray-500">Contacto a través del portal</p>
              </div>
            </div>
          </div>
          ...
          <div v-if="property.description" class="p-4 bg-gray-50 dark:bg-gray-800 rounded-xl">
            <h4 class="text-xs font-black text-gray-500 uppercase tracking-widest mb-2">Descripción</h4>
...
const emit = defineEmits(['close', 'schedule-visit'])
...
const handleScheduleVisit = () => {
  emit('schedule-visit', props.property)
  emit('close')
}
</script>
import { apiClient as api, apiClientV2 } from '@/core/api';
import type { UserType, User } from '@/modules/users/types/user';
  ...
  async createUser(payload: Record<string, unknown>): Promise<User> {
    const apiPayload: Record<string, unknown> = {
      ...
      roleIds: payload.roleIds || [
        getRoleIdByUserType(payload.userType as import('@/modules/users/types/user').UserType),
      ],

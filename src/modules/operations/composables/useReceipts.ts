import { ref } from 'vue';
import { receiptService } from '@/modules/operations/services/receiptService';
import type { Receipt, ReceiptUploadPayload } from '@/modules/operations/types/receipt';
import {
  ALLOWED_MIME_TYPES,
  MAX_FILE_SIZE_BYTES,
  ALLOWED_TYPE_LABELS,
} from '@/modules/operations/types/receipt';

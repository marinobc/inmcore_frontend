        ...
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <p class="text-xs text-gray-500 mt-0.5">
              <FwbBadge>
                {{ t('receiptsSection.badge', receipts.length) }}
              </FwbBadge>
            </p>
          </div>
        </div>
      ...
      <div class="flex flex-wrap gap-4 justify-between items-center">
        <div>
          ...
          <p class="text-lg font-bold text-gray-800 mt-0.5">
            <FwbBadge>{{ t('receiptsSection.badge', receipts.length) }}</FwbBadge>
          </p>
        </div>
...
<script setup lang="ts">
  ...
  import { useReceipts } from '@/modules/operations/composables/useReceipts';
